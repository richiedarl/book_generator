      ...
      <div className="auth-page">
        <div className="auth-container">
          <div className="auth-header">
            ...
            <p>Start building your book today</p>
          </div>
          <form className="auth-form">
            <div className="form-group">
              <label htmlFor="name">Name</label>
              <input type="text" id="name" placeholder="Your name" required disabled />
            </div>
            <div className="form-group">
            ...
            <div className="form-group">
              ...
              <input type="password" id="password" placeholder="At least 8 characters" required disabled />
            </div>
            <div className="form-group">
              <label htmlFor="confirmPassword">Confirm Password</label>
              <input type="password" id="confirmPassword" placeholder="Confirm your password" required disabled />
            </div>
            <button type="submit" className="btn-primary" disabled>Create Account</button>
          </form>
